...
var mocha2 =  order("mocha"); 

var coffees = [black, cappuccino, frappuccino, mocha, mocha2];

Promise.race(coffees)
...
function pay(amount) {if(money > amount) {money = money - amount;} else throw new Error("Not enough money")};
